# Better Agent Terminal - Development Guide
...
Output locations:
- macOS App: `src-tauri/target/release/bundle/macos/Better Agent Terminal.app`
- macOS DMG: `src-tauri/target/release/bundle/dmg/Better Agent Terminal_*.dmg`
