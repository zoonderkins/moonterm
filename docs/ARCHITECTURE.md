# Better Agent Terminal - Architecture

## Overview

Better Agent Terminal is a multi-workspace terminal aggregator built with Tauri 2.x, React, and xterm.js. It provides a unified interface for managing multiple terminal sessions across different project workspaces.
